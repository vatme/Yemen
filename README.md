...
5. Browse to the folder where you extracted the zip file in step 3 and choose the OYSC.prf file
...
3. Open the extracted files and copy the DataFiles folder and OYSC.ese file. Go to your current sector file folder for OYSC and replace the DataFiles and .ese file with the ones you just copied. 
